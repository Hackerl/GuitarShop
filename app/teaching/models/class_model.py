...
class class_model(model_base, db.Model):
    ...
    teaching_type = db.Column(db.String(100), nullable=False, default='')
    teaching_address = db.Column(db.String(100), nullable=False, default='')
    ...
    files = db.Column(db.Text, nullable=False, default='[]')
